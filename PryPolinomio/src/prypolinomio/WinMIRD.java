 ...
 * @author PC
 */
public class WinMIRD extends javax.swing.JFrame {

    /**
     * Creates new form WinMIRD
     */
    public WinMIRD() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WinMIRD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
