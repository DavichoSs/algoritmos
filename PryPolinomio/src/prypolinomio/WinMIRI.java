 ...
 * @author PC
 */
public class WinMIRI extends javax.swing.JFrame {

    /**
     * Creates new form WinMIRI
     */
    public WinMIRI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("INTEGRACIÓN POR RECTÁNGULOS IZQUIERDOS");
    ...
    private void BtnIntegrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnIntegrarActionPerformed
        ...
        LblSuma.setText(String.valueOf(p.sumatoriaMIRI(var1, var2, n)));
        LblResultado.setText(String.valueOf(p.MIRI(var1, var2, n)));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WinMIRI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
